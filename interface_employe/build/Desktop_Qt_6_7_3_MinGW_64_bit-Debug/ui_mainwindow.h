...
"    QPushButton#btnSupprimer { background-c"
                        "olor: #5D4037; }\n"
...
"\n"
"    QPushButton#btnEmployes, QPushButton#btnClients, QPushButton#btnCommandes, QPushButton#btnStock, QPushButton#btnAtelier {\n"
"      background-color: "
                        "#C9B59A; color: #3D2817; border: none; border-left: 0px solid #8B5A2B;\n"
"      border-radius: 0; padding: 20px 15px; font-size: 15pt; font-weight: bold; text-align: left;\n"
"    }\n"
"    QPushButton#btnEmployes:hover, QPushButton#btnClients:hover, QPushButton#btnCommandes:hover, QPushButton#btnStock:hover, QPushButton#btnAtelier:hover {\n"
"      background-color: #9B8068; color: white;\n"
"    }\n"
"    QPushButton#btnEmployes:checked, QPushButton#btnClients:checked, QPushButton#btnCommandes:checked, QPushButton#btnStock:checked, QPushButton#btnAtelier:checked {\n"
"      background-color: #8B5A2B; color: #F5EBE0; border-left: 6px solid #5D4037;\n"
"    }\n"
"    QPushButton#btnEmployes:pressed, QPushButton#btnClients:pressed, QPushButton#btnCommandes:pressed, QPushButton#btnStock:pressed, QPushButton#btnAtelier:pressed {\n"
"      background-color: #5D4037; color: white;\n"
"    }\n"
"\n"
"    /* \342\234\205 D\303\251connexion rouge */\n"
"    QPushButton#btnDeconnexion {\n"
"      background-color: #C0"
                        "392B; color: white; font-weight: bold;\n"
"    }\n"
...
"   "));
        ...
        verticalLayoutSidebar->setContentsMargins(0, 10, 0, 10);
        ...
        btnDeconnexion = new QPushButton(sidebar);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnDeconnexion->setText(QCoreApplication::translate("MainWindow", "D\303\251connexion", nullptr));
    } // retranslateUi
