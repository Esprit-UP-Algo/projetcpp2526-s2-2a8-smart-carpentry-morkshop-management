...
public:
    ...
    void setupUi(QWidget *HomeWidget)
    {
        ...
        lineEmail = new QLineEdit(HomeWidget);
        lineEmail->setObjectName("lineEmail");
        lineEmail->setMinimumSize(QSize(300, 40));

        verticalLayout->addWidget(lineEmail, 0, Qt::AlignmentFlag::AlignHCenter);

        linePassword = new QLineEdit(HomeWidget);
        linePassword->setObjectName("linePassword");
        linePassword->setMinimumSize(QSize(300, 40));
        linePassword->setEchoMode(QLineEdit::Password);

        verticalLayout->addWidget(linePassword, 0, Qt::AlignmentFlag::AlignHCenter);
    ...
    void retranslateUi(QWidget *HomeWidget)
    {
        ...
        lineEmail->setPlaceholderText(QCoreApplication::translate("HomeWidget", "Email", nullptr));
        linePassword->setPlaceholderText(QCoreApplication::translate("HomeWidget", "Mot de passe ", nullptr));
        btnAccederModules->setText(QCoreApplication::translate("HomeWidget", "Se connecter", nullptr));
