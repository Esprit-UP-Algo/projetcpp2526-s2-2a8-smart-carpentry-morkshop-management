...
public:
    ...
    void setupUi(QWidget *EmployeWidget)
    {
        ...
        btnValider->setStyleSheet(QString::fromUtf8("background-color: #8B9B6A; color: white; font-weight: bold;"));
        ...
        btnConfirmerModification->setStyleSheet(QString::fromUtf8("background-color: #8B5A2B; color: white; font-weight: bold;"));
        ...
        tableWidgetEmployes->setEditTriggers(QAbstractItemView::NoEditTriggers);
