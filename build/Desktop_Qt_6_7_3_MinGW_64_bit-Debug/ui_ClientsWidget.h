...
public:
    ...
    QLabel *labelTotalSociete;
    QLabel *labelTotalSocieteValeur;
    QLabel *labelTotalCIN;
    QLabel *labelTotalCINValeur;
    QLabel *labelTotalGmail;
    QLabel *labelTotalGmailValeur;
...
"   "));
        ...
        btnConfirmerModification = new QPushButton(groupBoxInfo);
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, btnConfirmerModification);
        ...
        groupRecherche = new QGroupBox(tabAffichage);
        ...
        verticalLayout_4->addWidget(groupRecherche);
        ...
        tableWidgetClients->setEditTriggers(QAbstractItemView::NoEditTriggers);
        ...
        labelTotalSociete = new QLabel(groupBoxStats);
        labelTotalSociete->setObjectName("labelTotalSociete");

        gridLayout_2->addWidget(labelTotalSociete, 1, 0, 1, 1);

        labelTotalSocieteValeur = new QLabel(groupBoxStats);
        labelTotalSocieteValeur->setObjectName("labelTotalSocieteValeur");

        gridLayout_2->addWidget(labelTotalSocieteValeur, 1, 1, 1, 1);

        labelTotalCIN = new QLabel(groupBoxStats);
        labelTotalCIN->setObjectName("labelTotalCIN");

        gridLayout_2->addWidget(labelTotalCIN, 2, 0, 1, 1);

        labelTotalCINValeur = new QLabel(groupBoxStats);
        labelTotalCINValeur->setObjectName("labelTotalCINValeur");

        gridLayout_2->addWidget(labelTotalCINValeur, 2, 1, 1, 1);

        labelTotalGmail = new QLabel(groupBoxStats);
        labelTotalGmail->setObjectName("labelTotalGmail");

        gridLayout_2->addWidget(labelTotalGmail, 3, 0, 1, 1);

        labelTotalGmailValeur = new QLabel(groupBoxStats);
        labelTotalGmailValeur->setObjectName("labelTotalGmailValeur");

        gridLayout_2->addWidget(labelTotalGmailValeur, 3, 1, 1, 1);

        btnActualiserStats = new QPushButton(groupBoxStats);
        btnActualiserStats->setObjectName("btnActualiserStats");

        gridLayout_2->addWidget(btnActualiserStats, 4, 0, 1, 1);
    ...
    void retranslateUi(QWidget *ClientsWidget)
    {
        ...
        lineEditSiteWeb->setPlaceholderText(QCoreApplication::translate("ClientsWidget", "https:// ou www. ou facebook.com/ (facultatif)", nullptr));
        btnValider->setText(QCoreApplication::translate("ClientsWidget", "Valider", nullptr));
        btnConfirmerModification->setText(QCoreApplication::translate("ClientsWidget", "Confirmer modification", nullptr));
        ...
        labelTotalClients->setText(QCoreApplication::translate("ClientsWidget", "Total clients :", nullptr));
        labelTotalClientsValeur->setText(QCoreApplication::translate("ClientsWidget", "0", nullptr));
        labelTotalSociete->setText(QCoreApplication::translate("ClientsWidget", "Clients avec soci\303\251t\303\251 :", nullptr));
        labelTotalSocieteValeur->setText(QCoreApplication::translate("ClientsWidget", "0", nullptr));
        labelTotalCIN->setText(QCoreApplication::translate("ClientsWidget", "Clients avec CIN :", nullptr));
        labelTotalCINValeur->setText(QCoreApplication::translate("ClientsWidget", "0", nullptr));
        labelTotalGmail->setText(QCoreApplication::translate("ClientsWidget", "Emails Gmail :", nullptr));
        labelTotalGmailValeur->setText(QCoreApplication::translate("ClientsWidget", "0", nullptr));
