...
public:
    ...
    QPushButton *btnConfirmerModification;
    ...
    QLabel *labelSalaireTotal;
    QLabel *labelSalaireTotalValeur;
    QLabel *labelSalaireMoyen;
    QLabel *labelSalaireMoyenValeur;
    QLabel *labelDispoCount;
    QLabel *labelDispoValeur;
    QLabel *labelCongeCount;
    QLabel *labelCongeValeur;
    QLabel *labelAbsentCount;
    QLabel *labelAbsentValeur;
    QPushButton *btnActualiserStats;
    QWidget *tabAbsences;
    QVBoxLayout *vboxLayout2;
    QHBoxLayout *hboxLayout1;
    QPushButton *btnActualiserAbsences;
    QPushButton *btnExportAbsencesPDF;
    QTableWidget *tableWidgetAbsences;
    ...
    void setupUi(QWidget *EmployeWidget)
    {
        ...
        textEditAdresse->setMinimumHeight(60);
        textEditAdresse->setMaximumHeight(80);

        formLayoutEmploye->setWidget(8, QFormLayout::FieldRole, textEditAdresse);

        btnValider = new QPushButton(groupBoxInfoEmployes);
        btnValider->setObjectName("btnValider");
        btnValider->setStyleSheet(QString::fromUtf8("\n"
"background-color: #8B9B6A; color: white; font-weight: bold;\n"
"QPushButton#btnValider:hover { background-color: #9BAB7A; }\n"
"             "));

        formLayoutEmploye->setWidget(9, QFormLayout::FieldRole, btnValider);

        btnConfirmerModification = new QPushButton(groupBoxInfoEmployes);
        btnConfirmerModification->setObjectName("btnConfirmerModification");
        btnConfirmerModification->setStyleSheet(QString::fromUtf8("\n"
"background-color: #8B5A2B; color: white; font-weight: bold;\n"
"QPushButton#btnConfirmerModification:hover { background-color: #9B8068; }\n"
"             "));

        formLayoutEmploye->setWidget(10, QFormLayout::FieldRole, btnConfirmerModification);
        ...
        btnRenvoyerCode = new QPushButton(groupBoxActions);
        btnRenvoyerCode->setObjectName("btnRenvoyerCode");

        hboxLayout->addWidget(btnRenvoyerCode);
        ...
        vboxLayout1 = new QVBoxLayout(tabStatistiques);
        ...
        labelTotalEmp = new QLabel(groupBoxStats);
        labelTotalEmp->setObjectName("labelTotalEmp");

        gridLayout->addWidget(labelTotalEmp, 0, 0, 1, 1);
        ...
        labelSalaireTotal = new QLabel(groupBoxStats);
        labelSalaireTotal->setObjectName("labelSalaireTotal");

        gridLayout->addWidget(labelSalaireTotal, 1, 0, 1, 1);

        labelSalaireTotalValeur = new QLabel(groupBoxStats);
        labelSalaireTotalValeur->setObjectName("labelSalaireTotalValeur");

        gridLayout->addWidget(labelSalaireTotalValeur, 1, 1, 1, 1);

        labelSalaireMoyen = new QLabel(groupBoxStats);
        labelSalaireMoyen->setObjectName("labelSalaireMoyen");

        gridLayout->addWidget(labelSalaireMoyen, 2, 0, 1, 1);

        labelSalaireMoyenValeur = new QLabel(groupBoxStats);
        labelSalaireMoyenValeur->setObjectName("labelSalaireMoyenValeur");

        gridLayout->addWidget(labelSalaireMoyenValeur, 2, 1, 1, 1);

        labelDispoCount = new QLabel(groupBoxStats);
        labelDispoCount->setObjectName("labelDispoCount");

        gridLayout->addWidget(labelDispoCount, 3, 0, 1, 1);

        labelDispoValeur = new QLabel(groupBoxStats);
        labelDispoValeur->setObjectName("labelDispoValeur");

        gridLayout->addWidget(labelDispoValeur, 3, 1, 1, 1);

        labelCongeCount = new QLabel(groupBoxStats);
        labelCongeCount->setObjectName("labelCongeCount");

        gridLayout->addWidget(labelCongeCount, 4, 0, 1, 1);

        labelCongeValeur = new QLabel(groupBoxStats);
        labelCongeValeur->setObjectName("labelCongeValeur");

        gridLayout->addWidget(labelCongeValeur, 4, 1, 1, 1);

        labelAbsentCount = new QLabel(groupBoxStats);
        labelAbsentCount->setObjectName("labelAbsentCount");

        gridLayout->addWidget(labelAbsentCount, 5, 0, 1, 1);

        labelAbsentValeur = new QLabel(groupBoxStats);
        labelAbsentValeur->setObjectName("labelAbsentValeur");

        gridLayout->addWidget(labelAbsentValeur, 5, 1, 1, 1);

        btnActualiserStats = new QPushButton(groupBoxStats);
        btnActualiserStats->setObjectName("btnActualiserStats");

        gridLayout->addWidget(btnActualiserStats, 6, 0, 1, 1);


        vboxLayout1->addWidget(groupBoxStats);

        tabWidget->addTab(tabStatistiques, QString());
        tabAbsences = new QWidget();
        tabAbsences->setObjectName("tabAbsences");
        vboxLayout2 = new QVBoxLayout(tabAbsences);
        vboxLayout2->setObjectName("vboxLayout2");
        hboxLayout1 = new QHBoxLayout();
        hboxLayout1->setObjectName("hboxLayout1");
        btnActualiserAbsences = new QPushButton(tabAbsences);
        btnActualiserAbsences->setObjectName("btnActualiserAbsences");

        hboxLayout1->addWidget(btnActualiserAbsences);

        btnExportAbsencesPDF = new QPushButton(tabAbsences);
        btnExportAbsencesPDF->setObjectName("btnExportAbsencesPDF");

        hboxLayout1->addWidget(btnExportAbsencesPDF);


        vboxLayout2->addLayout(hboxLayout1);

        tableWidgetAbsences = new QTableWidget(tabAbsences);
        tableWidgetAbsences->setObjectName("tableWidgetAbsences");

        vboxLayout2->addWidget(tableWidgetAbsences);

        tabWidget->addTab(tabAbsences, QString());
    ...
    void retranslateUi(QWidget *EmployeWidget)
    {
        ...
        comboBoxPoste->setItemText(0, QCoreApplication::translate("EmployeWidget", "Service client", nullptr));
        comboBoxPoste->setItemText(1, QCoreApplication::translate("EmployeWidget", "Responsable Atelier", nullptr));
        comboBoxPoste->setItemText(2, QCoreApplication::translate("EmployeWidget", "Responsable du Stock", nullptr));
        comboBoxPoste->setItemText(3, QCoreApplication::translate("EmployeWidget", "Responsable de Maintenance", nullptr));
        ...
        btnValider->setText(QCoreApplication::translate("EmployeWidget", "Valider", nullptr));
        btnConfirmerModification->setText(QCoreApplication::translate("EmployeWidget", "Confirmer modification", nullptr));
        ...
        btnRenvoyerCode->setText(QCoreApplication::translate("EmployeWidget", "Renvoyer code d'acc\303\250s", nullptr));
        ...
        groupBoxStats->setTitle(QCoreApplication::translate("EmployeWidget", "Statistiques des employ\303\251s", nullptr));
        labelTotalEmp->setText(QCoreApplication::translate("EmployeWidget", "Total employ\303\251s :", nullptr));
        labelTotalEmployesValeur->setText(QCoreApplication::translate("EmployeWidget", "0", nullptr));
        labelSalaireTotal->setText(QCoreApplication::translate("EmployeWidget", "Salaire total :", nullptr));
        labelSalaireTotalValeur->setText(QCoreApplication::translate("EmployeWidget", "0", nullptr));
        labelSalaireMoyen->setText(QCoreApplication::translate("EmployeWidget", "Salaire moyen :", nullptr));
        labelSalaireMoyenValeur->setText(QCoreApplication::translate("EmployeWidget", "0", nullptr));
        labelDispoCount->setText(QCoreApplication::translate("EmployeWidget", "Disponibles :", nullptr));
        labelDispoValeur->setText(QCoreApplication::translate("EmployeWidget", "0", nullptr));
        labelCongeCount->setText(QCoreApplication::translate("EmployeWidget", "En cong\303\251 :", nullptr));
        labelCongeValeur->setText(QCoreApplication::translate("EmployeWidget", "0", nullptr));
        labelAbsentCount->setText(QCoreApplication::translate("EmployeWidget", "Absents :", nullptr));
        labelAbsentValeur->setText(QCoreApplication::translate("EmployeWidget", "0", nullptr));
        btnActualiserStats->setText(QCoreApplication::translate("EmployeWidget", "Actualiser les statistiques", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabStatistiques), QCoreApplication::translate("EmployeWidget", "Statistiques", nullptr));
        btnActualiserAbsences->setText(QCoreApplication::translate("EmployeWidget", "Actualiser absences", nullptr));
        btnExportAbsencesPDF->setText(QCoreApplication::translate("EmployeWidget", "Exporter absences PDF", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabAbsences), QCoreApplication::translate("EmployeWidget", "Absences", nullptr));
    } // retranslateUi
