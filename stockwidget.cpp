...
void StockWidget::onGenererReappro() { /* inchangé */ }
void StockWidget::onPrevision() { /* inchangé */ }
void StockWidget::onExportPDF() { /* inchangé */ }
void StockWidget::onExportCSV() { /* inchangé */ }
void StockWidget::onExportExcel() { /* inchangé */ }
void StockWidget::remplirStats() { /* inchangé */ }
void StockWidget::exporterCSV(const QString&) { /* inchangé */ }
