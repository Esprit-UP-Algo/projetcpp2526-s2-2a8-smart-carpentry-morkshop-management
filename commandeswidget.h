...
#include <QWidget>
#include <QSqlQuery>
#include "QRCodeManager.h"  // AJOUTER CETTE LIGNE
...
private:
    ...
    QRCodeManager qrManager;  // AJOUTER CETTE LIGNE
    ...
    QString genererUrlPaiement(int row);  // AJOUTER CETTE LIGNE
    void genererFactureAvecQR(const QString &chemin, int row);  // AJOUTER CETTE LIGNE
};
